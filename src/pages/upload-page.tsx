...
export function UploadPage() {
  ...
  return (
    <Layout
      title="Chuẩn hóa bài giảng"
      subtitle="Bản thiết kế chuẩn hóa chương trình học nghiệm • ndak79/Lesson_Norm"
      headerActions={
        <div className="flex flex-wrap items-center justify-end gap-3">
          <ProviderStatusBadge label="Hệ thống" status={backendStatus} />
          <ProviderStatusBadge label="Cổng AI" status={providerStatus} />
        </div>
      }
    >
      <div className="space-y-6">
        ...
        <div className="bg-[#4B5E40] rounded-[32px] p-8 md:p-10 text-white relative overflow-hidden flex flex-col justify-between shadow-xl min-h-[220px]">
          <div className="relative z-10 w-full">
            <h3 className="text-2xl md:text-3xl font-serif mt-2 w-full leading-snug">Chuẩn hóa cấu trúc khung bài giảng kỹ thuật số</h3>
